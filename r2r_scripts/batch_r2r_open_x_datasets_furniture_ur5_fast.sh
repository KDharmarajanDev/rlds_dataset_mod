...
DOWNLOAD_DIR=/shared/projects/mirage2/mask_octo_oxe_fast
CONVERSION_DIR=/shared/projects/mirage2/r2r_octo_oxe_fast
...
DATASET_TRANSFORMS=(
    "furniture_bench_dataset_converted_externally_to_rlds 0.1.0 r2r"
)
