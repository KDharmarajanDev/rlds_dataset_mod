...
DOWNLOAD_DIR=/shared/projects/mirage2/merged_r2r_octo_oxe
CONVERSION_DIR=/shared/projects/mirage2/finished_finetune_dataset
...
DATASET_TRANSFORMS=(
    "roboturk_franka 0.1.0 view_augmentation"
)
