...
DOWNLOAD_DIR=/shared/projects/mirage2/r2r_octo_oxe_fast
CONVERSION_DIR=/shared/projects/mirage2/video_inpaint_octo_oxe
...
DATASET_TRANSFORMS=(
    "stanford_hydra_dataset_converted_externally_to_rlds 0.1.0 video_inpaint"
)
